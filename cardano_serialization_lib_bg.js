...
/**
*/
export const CertificateKind = Object.freeze({ StakeRegistration:0,StakeDeregistration:1,StakeDelegation:2,PoolRegistration:3,PoolRetirement:4,GenesisKeyDelegation:5,MoveInstantaneousRewardsCert:6, });
/**
*/
export const MIRPot = Object.freeze({ Reserves:0,Treasury:1, });
/**
*/
export const RelayKind = Object.freeze({ SingleHostAddr:0,SingleHostName:1,MultiHostName:2, });
/**
*/
export const TransactionMetadatumKind = Object.freeze({ MapTransactionMetadatumToTransactionMetadatum:0,ArrTransactionMetadatum:1,Int:2,Bytes:3,Text:4, });
/**
*/
export const MultisigScriptKind = Object.freeze({ MsigPubkey:0,MsigAll:1,MsigAny:2,MsigNOfK:3, });
/**
*/
...
export class ByronAddress {
    ...
    * @returns {ByronAddress}
    */
    static from_icarus_key(key, network) {
        _assertClass(key, Bip32PublicKey);
        var ret = wasm.byronaddress_from_icarus_key(key.ptr, network);
        return ByronAddress.__wrap(ret);
    }
    /**
    * @param {string} s
...
export class MapTransactionMetadatumToTransactionMetadatum {
    ...
    */
    to_bytes() {
        wasm.maptransactionmetadatumtotransactionmetadatum_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.maptransactionmetadatumtotransactionmetadatum_from_bytes(ptr0, len0);
    ...
    */
    static new() {
        var ret = wasm.maptransactionmetadatumtotransactionmetadatum_new();
        return MapTransactionMetadatumToTransactionMetadatum.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    len() {
        var ret = wasm.maptransactionmetadatumtotransactionmetadatum_len(this.ptr);
        return ret >>> 0;
    }
    /**
    ...
    */
    insert(key, value) {
        ...
        var ret = wasm.maptransactionmetadatumtotransactionmetadatum_insert(this.ptr, key.ptr, value.ptr);
    ...
    */
    get(key) {
        _assertClass(key, TransactionMetadatum);
        var ret = wasm.maptransactionmetadatumtotransactionmetadatum_get(this.ptr, key.ptr);
        return ret === 0 ? undefined : TransactionMetadatum.__wrap(ret);
    }
    /**
    ...
    */
    keys() {
        var ret = wasm.maptransactionmetadatumtotransactionmetadatum_keys(this.ptr);
        return TransactionMetadatums.__wrap(ret);
    }
}
/**
*/
...
export class MsigAll {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MsigAll.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_msigall_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        wasm.msigall_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.msigall_from_bytes(ptr0, len0);
        return MsigAll.__wrap(ret);
    }
    /**
    * @returns {MultisigScripts}
    */
    multisig_scripts() {
        var ret = wasm.msigall_multisig_scripts(this.ptr);
        return MultisigScripts.__wrap(ret);
    }
    /**
    * @param {MultisigScripts} multisig_scripts
    * @returns {MsigAll}
    */
    static new(multisig_scripts) {
        _assertClass(multisig_scripts, MultisigScripts);
        var ret = wasm.msigall_new(multisig_scripts.ptr);
        return MsigAll.__wrap(ret);
    }
}
/**
...
export class MsigAny {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MsigAny.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_msigany_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        wasm.msigany_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.msigany_from_bytes(ptr0, len0);
        return MsigAny.__wrap(ret);
    }
    /**
    * @returns {MultisigScripts}
    */
    multisig_scripts() {
        var ret = wasm.msigany_multisig_scripts(this.ptr);
        return MultisigScripts.__wrap(ret);
    }
    /**
    * @param {MultisigScripts} multisig_scripts
    ...
    */
    static new(multisig_scripts) {
        _assertClass(multisig_scripts, MultisigScripts);
        var ret = wasm.msigany_new(multisig_scripts.ptr);
        return MsigAny.__wrap(ret);
    }
}
/**
...
export class MsigNOfK {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MsigNOfK.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_msignofk_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        wasm.msignofk_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.msignofk_from_bytes(ptr0, len0);
        return MsigNOfK.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    n() {
        var ret = wasm.msignofk_n(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {MultisigScripts}
    */
    multisig_scripts() {
        var ret = wasm.msignofk_multisig_scripts(this.ptr);
        return MultisigScripts.__wrap(ret);
    }
    /**
    * @param {number} n
    ...
    * @returns {MsigNOfK}
    */
    static new(n, multisig_scripts) {
        _assertClass(multisig_scripts, MultisigScripts);
        var ret = wasm.msignofk_new(n, multisig_scripts.ptr);
        return MsigNOfK.__wrap(ret);
    }
}
/**
...
export class MsigPubkey {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MsigPubkey.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_msigpubkey_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        wasm.msigpubkey_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.msigpubkey_from_bytes(ptr0, len0);
        return MsigPubkey.__wrap(ret);
    }
    /**
    * @returns {Ed25519KeyHash}
    */
    addr_keyhash() {
        var ret = wasm.msigpubkey_addr_keyhash(this.ptr);
        return Ed25519KeyHash.__wrap(ret);
    }
    /**
    ...
    */
    static new(addr_keyhash) {
        ...
        var ret = wasm.msigpubkey_new(addr_keyhash.ptr);
        return MsigPubkey.__wrap(ret);
    }
}
/**
...
export class MultiHostName {
    ...
    */
    dns_name() {
        try {
            wasm.multihostname_dns_name(8, this.ptr);
            var r0 = getInt32Memory0()[8 / 4 + 0];
            var r1 = getInt32Memory0()[8 / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    static new(dns_name) {
        ...
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.multihostname_new(ptr0, len0);
        return MultiHostName.__wrap(ret);
    }
}
/**
...
export class MultisigScript {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MultisigScript.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_multisigscript_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        wasm.multisigscript_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.multisigscript_from_bytes(ptr0, len0);
        return MultisigScript.__wrap(ret);
    }
    /**
    * @param {Ed25519KeyHash} addr_keyhash
    * @returns {MultisigScript}
    */
    static new_msig_pubkey(addr_keyhash) {
        _assertClass(addr_keyhash, Ed25519KeyHash);
        var ret = wasm.multisigscript_new_msig_pubkey(addr_keyhash.ptr);
        return MultisigScript.__wrap(ret);
    }
    /**
    * @param {MultisigScripts} multisig_scripts
    * @returns {MultisigScript}
    */
    static new_msig_all(multisig_scripts) {
        _assertClass(multisig_scripts, MultisigScripts);
        var ret = wasm.multisigscript_new_msig_all(multisig_scripts.ptr);
        return MultisigScript.__wrap(ret);
    }
    /**
    * @param {MultisigScripts} multisig_scripts
    * @returns {MultisigScript}
    */
    static new_msig_any(multisig_scripts) {
        _assertClass(multisig_scripts, MultisigScripts);
        var ret = wasm.multisigscript_new_msig_any(multisig_scripts.ptr);
        return MultisigScript.__wrap(ret);
    }
    /**
    * @param {number} n
    ...
    * @returns {MultisigScript}
    */
    static new_msig_n_of_k(n, multisig_scripts) {
        _assertClass(multisig_scripts, MultisigScripts);
        var ret = wasm.multisigscript_new_msig_n_of_k(n, multisig_scripts.ptr);
        return MultisigScript.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    kind() {
        var ret = wasm.multisigscript_kind(this.ptr);
        return ret >>> 0;
    }
    /**
    ...
    */
    as_multisig_script0() {
        var ret = wasm.multisigscript_as_multisig_script0(this.ptr);
        return ret === 0 ? undefined : MsigPubkey.__wrap(ret);
    }
    /**
    * @returns {MsigAll | undefined}
    */
    as_multisig_script1() {
        var ret = wasm.multisigscript_as_multisig_script1(this.ptr);
        return ret === 0 ? undefined : MsigAll.__wrap(ret);
    }
    /**
    * @returns {MsigAny | undefined}
    */
    as_multisig_script2() {
        var ret = wasm.multisigscript_as_multisig_script2(this.ptr);
        return ret === 0 ? undefined : MsigAny.__wrap(ret);
    }
    /**
    * @returns {MsigNOfK | undefined}
    */
    as_multisig_script3() {
        var ret = wasm.multisigscript_as_multisig_script3(this.ptr);
        return ret === 0 ? undefined : MsigNOfK.__wrap(ret);
    }
}
/**
*/
export class MultisigScripts {
    ...
    static __wrap(ptr) {
        const obj = Object.create(MultisigScripts.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_multisigscripts_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        wasm.multisigscripts_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.multisigscripts_from_bytes(ptr0, len0);
        return MultisigScripts.__wrap(ret);
    }
    /**
    * @returns {MultisigScripts}
    */
    static new() {
        var ret = wasm.multisigscripts_new();
        return MultisigScripts.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    len() {
        var ret = wasm.multisigscripts_len(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} index
    ...
    */
    get(index) {
        var ret = wasm.multisigscripts_get(this.ptr, index);
        return MultisigScript.__wrap(ret);
    }
    /**
    ...
    */
    add(elem) {
        _assertClass(elem, MultisigScript);
        wasm.multisigscripts_add(this.ptr, elem.ptr);
    }
}
/**
*/
...
export class PoolMetadata {
    ...
    */
    url() {
        try {
            wasm.poolmetadata_url(8, this.ptr);
            var r0 = getInt32Memory0()[8 / 4 + 0];
            var r1 = getInt32Memory0()[8 / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    static new(url, metadata_hash) {
        ...
        var ret = wasm.poolmetadata_new(ptr0, len0, metadata_hash.ptr);
        return PoolMetadata.__wrap(ret);
    }
}
/**
...
export class SingleHostName {
    ...
    */
    dns_name() {
        try {
            wasm.singlehostname_dns_name(8, this.ptr);
            var r0 = getInt32Memory0()[8 / 4 + 0];
            var r1 = getInt32Memory0()[8 / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    static new(port, dns_name) {
        var ptr0 = passStringToWasm0(dns_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.singlehostname_new(isLikeNone(port) ? 0xFFFFFF : port, ptr0, len0);
        return SingleHostName.__wrap(ret);
    }
}
/**
...
export class TransactionBody {
    ...
    */
    static new(inputs, outputs, fee, ttl) {
        ...
        var ret = wasm.transactionbody_new(inputs.ptr, outputs.ptr, fee.ptr, ttl);
        return TransactionBody.__wrap(ret);
    }
}
/**
...
export class TransactionMetadata {
    ...
    */
    static new() {
        var ret = wasm.transactionmetadata_new();
        return TransactionMetadata.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    len() {
        var ret = wasm.transactionmetadata_len(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {BigNum} key
    ...
    */
    insert(key, value) {
        ...
        _assertClass(value, TransactionMetadatum);
        var ret = wasm.transactionmetadata_insert(this.ptr, key.ptr, value.ptr);
        return ret === 0 ? undefined : TransactionMetadatum.__wrap(ret);
    }
    /**
    * @param {BigNum} key
    ...
    */
    get(key) {
        _assertClass(key, BigNum);
        var ret = wasm.transactionmetadata_get(this.ptr, key.ptr);
        return ret === 0 ? undefined : TransactionMetadatum.__wrap(ret);
    }
    /**
    ...
    */
    keys() {
        var ret = wasm.transactionmetadata_keys(this.ptr);
...
export class TransactionMetadatum {
    ...
    * @returns {TransactionMetadatum}
    */
    static new_map_transaction_metadatum_to_transaction_metadatum(map_transaction_metadatum_to_transaction_metadatum) {
        _assertClass(map_transaction_metadatum_to_transaction_metadatum, MapTransactionMetadatumToTransactionMetadatum);
        var ret = wasm.transactionmetadatum_new_map_transaction_metadatum_to_transaction_metadatum(map_transaction_metadatum_to_transaction_metadatum.ptr);
        return TransactionMetadatum.__wrap(ret);
    }
    /**
    ...
    * @returns {TransactionMetadatum}
    */
    static new_arr_transaction_metadatum(arr_transaction_metadatum) {
        _assertClass(arr_transaction_metadatum, TransactionMetadatums);
        var ret = wasm.transactionmetadatum_new_arr_transaction_metadatum(arr_transaction_metadatum.ptr);
        return TransactionMetadatum.__wrap(ret);
    }
    /**
    * @param {Int} int
    ...
    */
    as_map_transaction_metadatum_to_transaction_metadatum() {
        var ret = wasm.transactionmetadatum_as_map_transaction_metadatum_to_transaction_metadatum(this.ptr);
        return ret === 0 ? undefined : MapTransactionMetadatumToTransactionMetadatum.__wrap(ret);
    }
    /**
    * @returns {TransactionMetadatums | undefined}
    */
    as_arr_transaction_metadatum() {
        var ret = wasm.transactionmetadatum_as_arr_transaction_metadatum(this.ptr);
        return ret === 0 ? undefined : TransactionMetadatums.__wrap(ret);
    }
    /**
...
export class TransactionMetadatums {
    ...
    static __wrap(ptr) {
        const obj = Object.create(TransactionMetadatums.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_transactionmetadatums_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        wasm.transactionmetadatums_to_bytes(8, this.ptr);
        var r0 = getInt32Memory0()[8 / 4 + 0];
        var r1 = getInt32Memory0()[8 / 4 + 1];
        var v0 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
    ...
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.transactionmetadatums_from_bytes(ptr0, len0);
        return TransactionMetadatums.__wrap(ret);
    }
    /**
    * @returns {TransactionMetadatums}
    */
    static new() {
        var ret = wasm.transactionmetadatums_new();
        return TransactionMetadatums.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    len() {
        var ret = wasm.transactionmetadatums_len(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} index
    ...
    */
    get(index) {
        var ret = wasm.transactionmetadatums_get(this.ptr, index);
        return TransactionMetadatum.__wrap(ret);
    }
    /**
    ...
    */
    add(elem) {
        ...
        wasm.transactionmetadatums_add(this.ptr, elem.ptr);
    }
}
/**
*/
...
export class TransactionWitnessSet {
    ...
    */
    set_scripts(scripts) {
        _assertClass(scripts, MultisigScripts);
    ...
    */
    scripts() {
        ...
        return ret === 0 ? undefined : MultisigScripts.__wrap(ret);
    }
    /**
